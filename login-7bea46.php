<?php
    ...
    if(isset($users[$username]) && $users[$username]['pwd'] === substr($password_hash, 28)) {
        $_SESSION['session_id'] = 'DE6CCC07-34D2-42A4-8586-E87D562D4589';
        ...
        if(isset($_SESSION['user_redirect']) && !isset($_SESSION['user_redirect_attempt'])) {
            ...
            $homeURL = 'h18.php';
            $homeURLs = array('0' => 'plan-des-espaces-de-stockage-disponibles.html', '1' => 'h18.php');
